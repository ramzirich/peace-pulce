...
class OpenAiController extends Controller
{
    ...
    public function send_to_open_ai_api(Request $request){
        $system_config="make your answers concise and not too long never exceed 1000 character. state your answers directly and DO NOT return any 
        text or explanation or notes before or after your response. be human and don't be robotic. 
        ...
        i just want to see ur solutions so I have better approach and understanding of problems, the coomand will
