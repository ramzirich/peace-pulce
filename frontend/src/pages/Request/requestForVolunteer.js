...
export const RequestForVolunteer = ({navigation}) =>{
    ...
    useEffect(() =>{
        const fetchUserData = async() =>{
            try{
                ...
                const response =await  axios.get(`${config.apiUrl}/volunteer_patient_request_pending`,
                    {
                        headers:{
    ...
    acceptRequest = async(id) =>{
        try{
            ...
            const response = await axios.post(`${config.apiUrl}/volunteer_accept_request/update/${id}`,
            {
                request : 'accepted'
            },
            {
    ...
    deleteRequest = async(id) =>{
        try{
            const authToken = await AsyncStorage.getItem('authToken');
            const response = await axios.post(`${config.apiUrl}/volunteer_request/delete/${id}`,
            {
                request : 'accepted'
            },
            {
