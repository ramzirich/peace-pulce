...
export const Updatevalidation = (inputs, handleError) => {
    Keyboard.dismiss();
    let isValid = true;
    ...
    if (!inputs.phone) {
        handleError('Please input phonr number', 'phone');
        isValid = false;
      }else if(inputs.first_name.length>20){
          handleError('Phone number name cannot exceed 20 characters', 'phone');
          isValid = false;
      }
